...
For guidance on tuning cache sizes and memory usage on PathDB archive nodes, see [Nitro memory management](/run-arbitrum-node/nitro/05-nitro-memory-management.mdx).
